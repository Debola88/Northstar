        ...
        <div className='lg:flex md:flex lg:flex-1 items-center justify-end font-normal hidden'>
          <div className=''>
            <ul className='flex gap-8 mr-0 text-sm text-black'>
              <li className='hover:text-blue-800 transition cursor-pointer font-semibold'><nav><NavLink spy={true} smooth={true} to="/">HOME</NavLink></nav></li>
              <li className='hover:text-blue-800 transition cursor-pointer font-semibold'><nav><NavLink spy={true} smooth={true} to="/about">ABOUT</NavLink></nav></li>
              <li className='hover:text-blue-800 transition cursor-pointer font-semibold'><nav><NavLink spy={true} smooth={true} to="/ContactUs">CONTACT US</NavLink></nav></li>
              <li className='transition cursor-pointer ml-20'><nav><NavLink spy={true} smooth={true} to="/user"><LuUser className='text-lg'/></NavLink></nav></li>
