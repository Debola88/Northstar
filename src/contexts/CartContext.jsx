...
// creating some of the independent functions that will be used within the context
const addCartItem = (cartItems, itemToAdd) => {
  ...
  // if the item exists map the cartItem array and when you ger to the item with the same id, increase the quantity by one
  if (existingCartItem) {
...
export const CartProvider = ({ children }) => {
  ...
  //Helper function to get the total price 
